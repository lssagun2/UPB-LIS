            ...
            <ul class = "team">
              <li class = "team__item">
                <div class = "team__link">
                  ...
                  <form class = "inventory-total" style = "margin-left: 30px; margin-bottom: 30px; line-height: 30px;">
                    <label for = "inventoried" style = "font-size: 1.2em; margin-right: 37px;"><b>Inventoried:</b></label>
                    <input type = "text" id = "total-number-mat" style = "border-radius: 0; width: 50%; outline: none; border: 1px solid;"><br>
                    <label for = "not-inventoried" style = "font-size: 1.2em; margin-right: 0;"><b>Not Inventoried:</b></label>
                    <input type = "text" id = "total-number-mat" style = "border-radius: 0; width: 50%; outline: none; border: 1px solid;"><br>
                    <label for = "not-acquired" style = "font-size: 1.2em; margin-right: 21px;"><b>Not Acquired:</b></label>
                    <input type = "text" id = "total-number-mat" style = "border-radius: 0; width: 50%; outline: none; border: 1px solid;">
                  </form>
                </div>
              </li>
              <li class = "team__item">
              ...
              <li class = "team__item">
                <div class = "team__link">
                  <div class = "team__header">
                    <h2>Inventoried in 2019 and 2020</h2>
                  </div>
                  Some content1
                </div>
              </li>
