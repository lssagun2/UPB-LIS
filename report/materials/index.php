                    ...
                    <table>
                      ...
                      ?>
                        <tr class = "change-filter" data-filter = "type-filter" data-filter-value = "<?php echo $row["mat_type"];?>">
                          ...
                          <td style = "border: 1px solid 0.5; outline: none; width: 50%; padding-left: 42px;"><?php echo $row["type_count"];?></td>
                        </tr>
                      <?php
                        }
                      ?>
                    ...
                    <table>
                      ...
                      ?>
                        <tr class = "change-filter" data-filter = "status-filter" data-filter-value = "<?php echo $row["mat_status"];?>">
                          ...
                          <td style = "border: 1px solid 0.5; outline: none; width: 50%; padding-left: 42px;"><?php echo $row["status_count"];?></td>
                        </tr>
                      <?php
                        }
                      ?>
                    ...
                    <table>
                      ...
                      ?>
                        <tr class = "change-filter" data-filter = "circtype-filter" data-filter-value = "<?php echo $row["mat_circ_type"];?>">
                          ...
                          <td style = "border: 1px solid 0.5; outline: none; width: 50%; padding-left: 42px;"><?php echo $row["circ_type_count"];?></td>
                        </tr>
                      <?php
                        }
                      ?>
                    ...
                    <table>
                      ...
                      ?>
                        <tr class = "change-filter" data-filter = "location-filter" data-filter-value = "<?php echo $row["mat_location"];?>">
                          ...
                          <td style = "border: 1px solid 0.5; outline: none; width: 50%; padding-left: 42px;"><?php echo $row["location_count"];?></td>
                        </tr>
                      <?php
                        }
                      ?>
