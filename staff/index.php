        ...
        <main class = "main">
          <header class = "header">
            <div class = "header__wrapper">
              <h1><span class = "h1-admin">Manage</span> Staff</h1>
              <div class = "profile">
            ...
            <ul class = "project">
              <li class = "project__item">
                ...
                <!-- <div id = "addstaffModal" class = "modal">
                  <span onclick = "document.getElementById('addstaffModal').style.display = 'none'" class = "close" title = "Close Modal"><i class="fas fa-times"></i></span>
                  <form class = "modal-content" action = "">
                    <div class = "container" style = "overflow-y: auto; height: 480px;">
                      ...
                      <input type = "text" id = "middle_initial" name = "middleinitial" placeholder = "Middle Initial..">
                      ...
                      <div class = "clearfix">
                        ...
                        <button type = "button" class = "modalbtn" id = "add-staff">Add Staff</button>
                      </div>
                    </div>
                  </form>
                </div> -->
