          ...
          <form id = "material-edit" method = "POST" style="width: fit-content;">
            <div class = "container2">
              <fieldset id = "material-fieldset" style = "padding: 0; border: none;">
                ...
                <input type = "date" id = "acquisition_date" name = "acquisition_date" placeholder = "Acquisition Date.." value="" style="width: 80%;" ><button type = "button" id = "reset-acquisition-date" style="width: 15%;">Reset</button>
                <i class="fas fa-check-circle"></i>
                <i class="fas fa-exclamation-circle"></i>
