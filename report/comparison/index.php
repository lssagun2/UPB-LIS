        ...
        <main class = "main">
          ...
          <section class = "section">
            ...
            <?php
              $sql = "
                SELECT
                  SUM(CASE WHEN inv_$year1 = 1 THEN 1 ELSE 0 END) AS inventoried_$year1,
                  SUM(CASE WHEN inv_$year1 = 0 THEN 1 ELSE 0 END) AS not_inventoried_$year1,
                  SUM(CASE WHEN inv_$year1 = -1 THEN 1 ELSE 0 END) AS not_acquired_$year1,
                  SUM(CASE WHEN inv_$year2 = 1 THEN 1 ELSE 0 END) AS inventoried_$year2,
                  SUM(CASE WHEN inv_$year2 = 0 THEN 1 ELSE 0 END) AS not_inventoried_$year2,
                  SUM(CASE WHEN inv_$year2 = -1 THEN 1 ELSE 0 END) AS not_acquired_$year2,
          ...
          <section class = "section">
            ...
            <ul class = "team" style = "align-content: center;">
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 3 style = "text-align: center;">
              ...
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 2 style = "text-align: center;">
                  <div class = "team__header">
              ...
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 1 style = "text-align: center;">
                  <div class = "team__header">
              ...
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 0 style = "text-align: center;">
                  <div class = "team__header">
            ...
            <ul class = "project">
              <li class = "project__item" id = "table-materials" style="display: none">
                ...
                <div style="display: inline-block; width: 100%; margin-top: 20px;">
                  <div style = "float: left; width: 33%; font-size: 1.2em;">
                    Page
