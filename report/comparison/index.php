            ...
            <ul class = "team" style = "align-content: center;">
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 3 style = "text-align: center;">
                  ...
                  <h3 class = "report-gen-comp" id = "category_3" style = "padding: 5px 0;"></h3>
                </div>
              </li>
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 2 style = "text-align: center;">
                  ...
                  <h3 class = "report-gen-comp" id = "category_2" style = "padding: 5px 0;"></h3>
                </div>
              </li>
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 1 style = "text-align: center;">
                  ...
                  <h3 class = "report-gen-comp" id = "category_1" style = "padding: 5px 0;"></h3>
                </div>
              </li>
              <li class = "team__item">
                <div class = "team__link summary" data-comparison = true data-category = 0 style = "text-align: center;">
                  ...
                  <h3 class = "report-gen-comp" id = "category_0" style = "padding: 5px 0;"></h3>
                </div>
              </li>
            </ul>
          </section>
